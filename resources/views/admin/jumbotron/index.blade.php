...
<div class="row mb-3">
    ...
    <a href="{{ route('jumbotron.create') }}" class="btn btn-success ml-3 mr-3" ><i class="fas fa-plus mr-2"></i>Add new</a>
</div>
<div class="container">
       ...
       <div class="card">
           ...
           <div class="card-body">
            <p class="card-text"><small class="text-muted">{{ $item->title }}</small></p>
               ...
               <form action="{{ route('jumbotron.destroy', $item->id) }}" method="POST">
                   @csrf
                   @method('delete')
