...
<div class="row mb-3">
    ...
    <a href="{{ route('listcontent.create') }}" class="btn btn-success ml-3 mr-3" ><i class="fas fa-plus mr-2"></i>Add new</a>
</div>
...
<div class="card mb-4 py-3 border-left-primary">
    <div class="card-body">
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto ">
                <form action="{{ route('listcontent.destroy', $item->id) }}" method="POST">
                    @csrf
                    @method('delete')
                    ...
                    <button type="button" class="btn btn-info btn-circle " data-toggle="modal" data-target="#exampleModal{{ $item->id}}">
                        ...
                        <a href="{{ route('listcontent.edit', $item->id) }}" class="btn btn-warning btn-circle ">
        ...
        <div class="modal-body">
            <div class="card" style="" >
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">{{ $item->closing }}</p>
                </div>
