...
@section('title', 'Category of Content')  
@section('content')
@if (session('success'))
...
<div class="row mb-3">
    ...
    <a href="{{ route('categorycontent.create') }}" class="btn btn-success ml-3 mr-3" ><i class="fas fa-plus mr-2"></i>Add new</a>
</div>
...
<div class="card mb-4 py-3 border-left-primary">
    <div class="card-body">
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto ">
                <form action="{{ route('categorycontent.destroy', $item->id) }}" method="POST">
                    @csrf
                    @method('delete')
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{route('categorycontent.edit', $item->id) }}" class="btn btn-warning btn-circle ">
