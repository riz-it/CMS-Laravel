...
@section('content')
<form action="{{ route('categorycontent.update', $category->id) }}" method="POST">
    @csrf
    @method('patch')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="off" name="name" id="formGroupExampleInput" value="{{ $category->name }}">
            </div>
...
<a href="/categorycontent" class="btn btn-primary">Back</a>
@endsection